...
import { HaJimiEncodeService } from '@/service/HaJimiEncodeService.ts'
...
async function test() {
  ...
  console.log('原文To哈基密语', HaJimiEncodeService.encode(new TextEncoder().encode(str)))
  console.log('压缩结果To哈基密语', HaJimiEncodeService.encode(compressed))
